...
// Function prototypes for Vulkan debug functions
...
void VulkanDevice::createInstance() {
    ...
    appInfo.pApplicationName = "Vulkan PBR Renderer";
...
void VulkanDevice::endDebugLabel(VkCommandBuffer commandBuffer) {
...
void VulkanDevice::insertDebugLabel(VkCommandBuffer commandBuffer, const char* labelName,
                                    float r, float g, float b, float a) {
    static PFN_vkCmdInsertDebugUtilsLabelEXT pfnCmdInsertDebugUtilsLabelEXT = nullptr;
    
    if (pfnCmdInsertDebugUtilsLabelEXT == nullptr) {
        pfnCmdInsertDebugUtilsLabelEXT = reinterpret_cast<PFN_vkCmdInsertDebugUtilsLabelEXT>(
