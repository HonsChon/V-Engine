...
public:
    ...
    struct MaterialDescriptor {
        std::vector<VkDescriptorSet> sets;  // 每帧一个描述符�?
        bool valid = false;
    };
    ...
    // 获取 Uniform Buffers（供 GBuffer 等其�?Pass 共享使用�?
...
private:
    ...
    std::vector<VkDescriptorSet> globalDescriptorSets;  // 每帧一�?
